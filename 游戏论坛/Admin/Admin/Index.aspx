<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="游戏论坛.Admin.Admin.Index" %>
...
<body>
    <form class="form-inline definewidth m20" runat="server">
        ...
        <asp:Button ID="AddNew" CssClass="btn btn-success" runat="server" Text="新增管理员" OnClick="AddNew_Click" />

        
        <table class="table table-bordered table-hover m10" >
            <thead>
                <tr>
                    <th class="auto-style1">管理员id</th>
                    <th class="auto-style1">管理员名称</th>
                    <th class="auto-style1">真实姓名</th>
                    <th class="auto-style1">创建时间</th>
                    <th class="auto-style1">管理操作</th>
                </tr>
            </thead>
            <tbody>
                <asp:DataList ID="DataList1" runat="server" DataKeyField="aId"  OnEditCommand="DataList1_EditCommand" OnDeleteCommand="DataList1_DeleteCommand"   RepeatLayout = "Flow" RepeatDirection="Horizontal" >                   
                    <ItemTemplate>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("aUsername") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("aData") %>'></asp:Label>
                            </td>
                            <td>
