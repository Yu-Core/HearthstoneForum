<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="游戏论坛.Admin.Carousel.Edit" %>
...
<body>
    <form class="definewidth m20" runat="server">
        ...
        <table class="table table-bordered table-hover m10">
            <tr>
                <td style="width:10%" class="tableleft">图片编号</td>
                <td>
                    <asp:TextBox ID="c_Id" runat="server" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tableleft">标题</td>
                <td>
                    <asp:TextBox ID="c_Title" runat="server"  MaxLength="50"></asp:TextBox>
                </td>
            </tr>
        ...
        <script>
            function checking() {
                var c_Title = document.getElementById("<%=c_Title.ClientID%>");
                if (c_Title.value == "" || c_Title.value == null) {
                    return false;
                }
            }
