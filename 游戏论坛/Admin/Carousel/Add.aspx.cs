...
namespace 游戏论坛.Admin.Carousel
{
    public partial class Add : System.Web.UI.Page
    {
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            if (c_Title.Text == ""|| !FileUpload1.HasFile)
            {
            ...
            else
            {
                ...
                if (IsValidImage(FileUpload1.PostedFile))
                {
                    ...
                    string newfilename = (Convert.ToInt32(db.GetDataSet("select top 1 Id from tb_Carousel order by Id desc").Tables[0].Rows[0][0]) + 1).ToString() + fileext;
                ...
                string sql = "insert into tb_Carousel values ('" + iws.Replace(this.c_Title.Text, '*') + "','" + Imagefile + "')";
