<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="游戏论坛.Admin.Carousel.Index" %>
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="Id"  OnEditCommand="DataList1_EditCommand" OnDeleteCommand="DataList1_DeleteCommand" RepeatLayout = "Flow" RepeatDirection="Horizontal" >                   
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Image ID="Image1" runat="server" ImageUrl= '<%# "/images/Carouselmap/" +Eval("Imagefile") %>' style="max-height:100px" />
                            </td>
                            <td>
