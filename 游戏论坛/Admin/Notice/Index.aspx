<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="游戏论坛.Admin.Notice.Index" %>
...
<body>
    <form class="form-inline definewidth m20"  runat="server">  
        ...
        <asp:Button ID="AddNew" CssClass="btn btn-success" runat="server" Text="新增公告" OnClick="AddNew_Click" />
