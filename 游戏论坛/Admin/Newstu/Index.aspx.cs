...
namespace 游戏论坛.Admin.Newstu
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds_1 = db.GetDataSet("select * from tb_Newstu  order by Id desc");
        ...
        protected void DataList1_DeleteCommand(object source, DataListCommandEventArgs e)
        {
            ...
            string sql = "delete from tb_Newstu where Id = '" + id + "'";
        ...
        protected void Query_Click(object sender, EventArgs e)
        {
            if(Rolename.Text != "")
            {
                string sql = "select * from tb_Newstu where CHARINDEX('" + Rolename.Text + "',Title) > 0 order by Id desc";
