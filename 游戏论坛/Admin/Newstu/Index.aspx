<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="游戏论坛.Admin.Newstu.Index" %>
...
<body>
    <form class="form-inline definewidth m20"  runat="server">  
        ...
        <asp:Button ID="AddNew" CssClass="btn btn-success" runat="server" Text="添加图片" OnClick="AddNew_Click" />
                ...
                <asp:DataList ID="DataList1" runat="server" DataKeyField="Id"  OnEditCommand="DataList1_EditCommand" OnDeleteCommand="DataList1_DeleteCommand" RepeatLayout = "Flow" RepeatDirection="Horizontal" >                   
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Image ID="Image1" runat="server" ImageUrl= '<%# "/images/NewPlayerGuide/" +Eval("Imagefile") %>' style="max-height:100px" />
                            </td>
                            <td>
