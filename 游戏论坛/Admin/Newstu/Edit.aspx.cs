...
namespace 游戏论坛.Admin.Newstu
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request["id"] != null)
                {
                    ...
                    string sql = "select * from tb_Newstu where Id = '" + Request["id"] + "'";
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        c_Image.ImageUrl = "~/images/NewPlayerGuide/" + ds.Tables[0].Rows[0][3].ToString();
        ...
        {
            string Imagefile = db.GetDataSet("select Imagefile from tb_Newstu where Id = '" + Request["id"] + "'").Tables[0].Rows[0][0].ToString();
            if (FileUpload1.HasFile)
            {
                ...
                if (IsValidImage(FileUpload1.PostedFile))
                {
                    ...
                    this.FileUpload1.SaveAs(Server.MapPath("~/images/NewPlayerGuide/" + newfilename));
            ...
            if (N_Title.Text == "" || N_Content.Text == "")
            {
                ClientScript.RegisterClientScriptBlock(this.GetType(),
            ...
            else
            {
                ...
                string sql = "update tb_Newstu set Title = '" + iws.Replace(this.N_Title.Text, '*') + "',nContent = '" + iws.Replace(this.N_Content.Text, '*') + "',Imagefile = '" + Imagefile + "'where Id = '" + Request["id"] + "'";
