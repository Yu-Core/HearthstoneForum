...
namespace 游戏论坛.Admin.Newstu
{
    public partial class Add : System.Web.UI.Page
    {
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            if (N_Title.Text == ""||N_Content.Text == ""|| !FileUpload1.HasFile)
            {
            ...
            else
            {
                ...
                if (IsValidImage(FileUpload1.PostedFile))
                {
                    ...
                    string newfilename = (Convert.ToInt32(db.GetDataSet("select top 1 Id from tb_Newstu order by Id desc").Tables[0].Rows[0][0]) + 1).ToString() + fileext;
                ...
                string sql = "insert into tb_Newstu values ('" + iws.Replace(this.N_Title.Text, '*') + "','" + iws.Replace(this.N_Content.Text, '*') + "','" + Imagefile + "')";
