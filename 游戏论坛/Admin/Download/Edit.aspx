<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="游戏论坛.Admin.Download.Edit" %>
...
<body>
    <form class="definewidth m20" runat="server">
        ...
        <table class="table table-bordered table-hover m10">
            <tr>
                <td style="width:10%" class="tableleft">平台编号</td>
                <td>
                    <asp:TextBox ID="d_Id" runat="server" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tableleft">平台名称</td>
                <td>
                    <asp:TextBox ID="d_System" runat="server"  MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tableleft">安装包名称</td>
                <td>
                    <asp:TextBox ID="d_Download" runat="server" Enabled="False" MaxLength="20"></asp:TextBox>
        ...
        <script>
            function checking() {
                var System = document.getElementById("<%=d_System.ClientID%>");
                if (System.value == "" || System.value == null ) {
                    return false;
                }
            }
            ...
            var d_Download = document.getElementById("<%=d_Download.ClientID%>");
            var valuemap = {};
            valuemap[1] = d_Download.value;
            valuemap[2] = c_Image.src;
            ...
            function CheckFile(str) {
                ...
                if (re.test(str)) {
                    ...
                    c_Image.src = valuemap[2];
                    return (false);
                }
            }
           

            function CheckFile2(str) {
                
                if (str == '' || str == null) {
                    d_Download.value = valuemap[1];
                }
                else {
                    d_Download.value = str;
                }
            }
        </script>
    </form>
