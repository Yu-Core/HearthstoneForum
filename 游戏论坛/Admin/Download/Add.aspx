<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="游戏论坛.Admin.Download.Add" %>
...
<body>
    <form class="definewidth m20" runat="server">
        ...
        <table class="table table-bordered table-hover m10">
            ...
            <tr>
                <td style="width:10%" class="tableleft">平台名称</td>
                <td>
                    <asp:TextBox ID="d_System" runat="server"  MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="tableleft">安装包</td>
                <td>
        ...
        <script>
            function checking() {
                ...
                var F1 = document.getElementById("<%=FileUpload1.ClientID%>");
                var F2 = document.getElementById("<%=FileUpload2.ClientID%>");
                if (System.value == "" || F1.value == "" || F2.value == "") {
                    return false;
                }
            }
