...
namespace 游戏论坛.Admin.Download
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds_1 = db.GetDataSet("select * from tb_Download  order by Id desc");
        ...
        protected void DataList1_DeleteCommand(object source, DataListCommandEventArgs e)
        {
            ...
            string sql = "delete from tb_Download where Id = '" + id + "'";
        ...
        protected void Query_Click(object sender, EventArgs e)
        {
            if(Rolename.Text != "")
            {
                string sql = "select * from tb_Download where CHARINDEX('" + Rolename.Text + "',System) > 0 order by Id desc";
