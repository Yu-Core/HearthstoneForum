...
namespace 游戏论坛.Admin.Area
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds_1 = db.GetDataSet("select Id,areaName,introduction,Datatime from tb_Area  order by Datatime desc");
        ...
        protected void Query_Click(object sender, EventArgs e)
        {
            if (Rolename.Text != "")
            {
                string sql = "select Id,areaName,introduction,Datatime from tb_Area where CHARINDEX('" + Rolename.Text + "',areaName) > 0 order by Datatime desc";
