...
namespace 游戏论坛.Admin.Motif
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds_1 = db.GetDataSet("select m.Id,mName,uUsername,areaName,Views,m.Datatime from tb_Motif m,tb_User u,tb_Area a where m.Appearuser = u.uId and m.Areaid = a.Id order by m.Datatime desc");
        ...
        protected void Query_Click(object sender, EventArgs e)
        {
            if (Rolename.Text != "")
            {
                string sql = "select m.Id,mName,uUsername,areaName,Views,m.Datatime from tb_Motif m,tb_User u,tb_Area a where m.Appearuser = u.uId and m.Areaid = a.Id and CHARINDEX('" + Rolename.Text + "',mName) > 0 order by m.Datatime desc";
