<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="游戏论坛.Admin.Head.Add" %>
    ...
    <form class="definewidth m20" runat="server">
        ...
        <table class="table table-bordered table-hover m10">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="H_Name" runat="server"  MaxLength="50"></asp:TextBox>
                </td>
            </tr>
        ...
        <script>
            function checking() {
                var H_Name = document.getElementById("<%=H_Name.ClientID%>");
                if (H_Name.value == "" || H_Name.value == null) {
                    return false;
                }
            }
